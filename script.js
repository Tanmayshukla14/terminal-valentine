...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const hoverMessages = [
        ...
        "⚠️ This will break production",
        "Runtime Error: HeartNotFoundException",
        "❗ Failed to compile: missing valentine",
        "🚫 Access Denied: Love.lock in use",
        "⛔ Exception: NullPointerException at Heart.java:14"
    ];
    ...
    console.log('%c💻 Hey there, fellow developer! 💖', 'color: #ff6b9d; font-size: 20px; font-weight: bold;');
    console.log('%cLooks like you found the console. Nice!', 'color: #00d9ff; font-size: 14px;');
    console.log('%cFeel free to check out the code and make it your own!', 'color: #bd93f9; font-size: 14px;');
